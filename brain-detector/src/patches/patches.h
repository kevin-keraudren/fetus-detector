...
inline size_t index( size_t i, size_t j, size_t k, size_t l, size_t m,
                     size_t shape0, size_t shape1, size_t shape2, size_t shape3, size_t shape4 ) {
    return m + shape4*( l + shape3*( k + shape2*( j + shape1*i ) ) );
}
