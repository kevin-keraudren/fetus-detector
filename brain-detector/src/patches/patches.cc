                ...
                for ( int z = Z[i] - rz; z <= Z[i] + rz; z++ ) {
                    ...
                    if ( 0 <= x && x < shape2 &&
                        ...
                        patches[index(i,
                                      ...
                                      2*rz+1,
                                      2*ry+1,
                                      2*rx+1)] = img[index(z,y,x,shape0,shape1,shape2)];
                    }
                }   
}
            ...
            for ( int y = Y[i] - ry; y <= Y[i] + ry; y++ )
                for ( int z = Z[i] - rz; z <= Z[i] + rz; z++ ) {
                    ...
                    if ( 0 <= x && x < shape2 &&
                        ...
                        img[index(z,y,x,shape0,shape1,shape2)] += patches[index(i,
                                                                                z-(Z[i]-rz),
                                                                                y-(Y[i]-ry),
                                                                                x-(X[i]-rx),
                                                                                nb_points,
                                                                                ...
                                                                                2*ry+1,
                                                                                2*rx+1)];
                        weights[index(z,y,x,shape0,shape1,shape2)] += 1;
                    }
                }   
}
                ...
                for ( int z = Z[i] - rz; z <= Z[i] + rz; z++ )
                    ...
                    if ( 0 <= x && x < shape3 &&
                        ...
                        patches[index(i,
                                      ...
                                      2*rz+1,
                                      2*ry+1,
                                      2*rx+1)] = img[index(t,z,y,x,shape0,shape1,shape2,shape3)];
                    }
                }   
}
            ...
            for ( int y = Y[i] - ry; y <= Y[i] + ry; y++ )
                for ( int z = Z[i] - rz; z <= Z[i] + rz; z++ )
                    ...
                    if ( 0 <= x && x < shape3 &&
                        ...
                        img[index(t,z,y,x,shape0,shape1,shape2,shape3)] += patches[index(i,
                                                                                         t,
                                                                                         z-(Z[i]-rz),
                                                                                         y-(Y[i]-ry),
                                                                                         x-(X[i]-rx),
                                                                                         ...
                                                                                         2*ry+1,
                                                                                         2*rx+1)];
                        weights[index(t,z,y,x,shape0,shape1,shape2,shape3)] += 1;
                    }
                }   
}
